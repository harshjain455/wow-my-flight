...
export const OperationsAgents = () => {
  ...
  return (
    <Box sx={{ height: 'calc(100vh - 120px)', display: 'flex', flexDirection: 'column' }}>
      ...
      >
        ...
        >
          ...
          <TextField
            ...
            fullWidth
            required
            helperText="Select the user system role determining permissions and sidebar access."
          >
      ...
      <Dialog open={openResetPasswordModal} onClose={() => setOpenResetPasswordModal(false)} maxWidth="xs" fullWidth
        PaperProps={{
          sx: {
            mx: { xs: 1.5, sm: 3 },
            my: { xs: 1, sm: 2 },
      ...
      >
        <DialogTitle sx={{ fontWeight: 800, flexShrink: 0, borderBottom: '1px solid', borderColor: 'divider', py: 2, px: { xs: 2, sm: 3 } }}>Reset Password Override</DialogTitle>
        <DialogContent className="modal-scroll" sx={{ pt: 2.5, px: { xs: 2, sm: 3 }, overflowY: 'auto' }}>
