  ...
  return (
    <Box>
      <PageHeader
        ...
        subtitle="Track leads, conversions, revenue and channel performance across all platforms including TikTok Ads."
      />
      ...
      <Box className="grid grid-cols-12 gap-2">
        ...
        <Box className="col-span-12 md:col-span-6">
          <Paper sx={{ p: 3, borderRadius: 3, border: '1px solid', borderColor: 'divider', boxShadow: 'none' }}>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>Share of leads per acquisition channel.</Typography>
